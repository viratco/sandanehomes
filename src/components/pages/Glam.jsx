...
const Glam = () => {
    const rooms = [
        ...
        {
            title: "Luxury Living",
            desc: "A sophisticated sitting area designed for your comfort and professional convenience.",
            image: room1
        }
    ];
    ...
    const reviews = [
        {
            ...
            date: "4 months ago",
            text: "I had a very good stay at this hotel. It feels safe, which is great for solo travelers. The room was clean, the bathroom was spotless, and a very nice balcony. Breakfast was provided. The owner is very welcoming, and the staff are also friendly and helpful. The hotel offers many useful services, making the stay easy and comfortable."
        },
        {
            name: "Dhiren Singh",
            date: "3 months ago",
            text: "The rooms are exceptionally clean and comfortable. The staff is very polite, humble, and always ready to assist. Beds are neat and tidy, and the service is truly top-notch. Highly recommended."
        },
        {
            name: "Anju Chahal",
            date: "2 weeks ago",
    ...
    return (
        <div className="sandane-homes-page">
            ...
            <div className="sandane-rooms-section">
                <h4 className="section-subtitle">Our Rooms</h4>
                <h2 className="section-title">Indulge in Luxury Explore <br /> Our Rooms</h2>
            ...
            <div className="sandane-services-section">
                <h2 className="section-title">Personalized Hospitality Discover <br /> Our Signature Services</h2>
            ...
            <div className="sandane-reviews-section">
                <h4 className="review-title">Your Reviews</h4>
