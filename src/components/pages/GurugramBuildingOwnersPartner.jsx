...
import {
  ...
  FaChevronDown, FaChevronUp, FaCity, FaBuilding as FaBuildingUser, FaSlidersH as FaSliders, FaMapMarkerAlt as FaLocationDot,
  FaCheckCircle as FaCircleCheck, FaTimes as FaXmark
} from 'react-icons/fa';
...
const GurugramBuildingOwnersPartner = () => {
  ...
  return (
    <div style={{ backgroundColor: '#0F172A', color: '#F8FAFC', minHeight: '100vh', fontFamily: "'Inter', system-ui, sans-serif" }}>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          <div style={{ backgroundColor: '#1E293B', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.08)', overflow: 'hidden', boxShadow: '0 20px 40px rgba(0,0,0,0.3)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '2fr 2fr 2fr', padding: '18px 24px', fontSize: '14px' }}>
              <div style={{ color: '#FFFFFF', fontWeight: '600' }}>Building Asset Appreciation</div>
              <div style={{ color: '#94A3B8' }}>High wear &amp; tear from unmonitored tenants</div>
              <div style={{ color: '#C5A572', fontWeight: '700', display: 'flex', alignItems: 'center', gap: '6px' }}><FaCircleCheck /> Hotel-Grade Capital Maintenance</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: '90px 20px', backgroundColor: '#0F172A', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto 60px' }}>
            ...
            <p style={{ color: '#94A3B8', fontSize: '16px', lineHeight: '1.8' }}>
              Sandane Homes is an institutional corporate housing and luxury boutique hotel management brand operating across Delhi NCR. We unlock maximum real estate asset yields for building developers and tower owners through turnkey master leasing and 5-star hotel-grade operations.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '30px' }}>
            <div style={{ background: '#1E293B', padding: '32px', borderRadius: '16px', border: '1px solid rgba(197,165,114,0.2)' }}>
              ...
              <p style={{ color: '#94A3B8', fontSize: '14px', lineHeight: '1.7', margin: 0 }}>
                We own and operate flagship luxury boutique hotels including <strong>CoCo House</strong>, <strong>Amaaltash by Sandane Homes</strong>, <strong>The Glam by Sandane Homes</strong>, and <strong>Amara Inn by Sandane Homes</strong>, bringing 5-star hotel management standards to full residential towers.
              </p>
            </div>
            ...
            <div style={{ background: '#1E293B', padding: '32px', borderRadius: '16px', border: '1px solid rgba(197,165,114,0.2)' }}>
              ...
              <p style={{ color: '#94A3B8', fontSize: '14px', lineHeight: '1.7', margin: 0 }}>
                We maintain your entire building like a luxury boutique hotel. Daily housekeeping, 24/7 lobby reception, security supervision, and facility engineering ensure high capital appreciation and zero asset wear-and-tear.
              </p>
            </div>
          </div>
        </div>
