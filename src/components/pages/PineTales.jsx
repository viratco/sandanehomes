...
import room2 from '../../assets/Copy of IMG_6567.JPG'; // New Room Image 2
        ...
        <div className="sandane-homes-page">
            ...
            <div className="sandane-hero-split">
                ...
                <div className="sandane-hero-image">
                    <img
                        src={heroImg}
                        alt="Pine Tales Luxury"
                        className="sandane-hero-img-el" // Use class
                    />
                </div>
                ...
                <div className="sandane-floating-buttons">
                    <button
                        className="btn-book"
                        onClick={() => window.open('https://www.airbnb.co.in/rooms/1222185299423292714?source_impression_id=p3_1770834223_P3oHM5v49KwrEa6x', '_blank')}
                    >
                        Book Now
                    </button>
                    <button
