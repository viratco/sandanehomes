        ...
        <div className="catarina-services sandane-homes-page" style={{ backgroundColor: '#F4F0EB', minHeight: '100vh', overflowX: 'hidden' }}>
            ...
            */}
            ...
            <div className="catarina-section catarina-accomm-section">
                ...
                {/* Creative Premium Enquire CTA Block */}
                <div style={{ display: 'flex', justifyContent: 'center' }}>
                    <div className="enquire-cta-wrapper">
                        {/* Concentric radar ping rings */}
                        <div className="enquire-radar-ping"></div>
                        <div className="enquire-radar-ping"></div>

                        {/* Live Status Indicator */}
                        <div className="enquire-live-status">
                            <span className="enquire-green-dot"></span>
                            <span>Relocation Desk Active</span>
                        </div>
                        ...
                        <a
                            ...
                            className="enquire-creative-btn"
                        >
                        ...
                        <div className="enquire-subtext">Average response time: &lt; 2 minutes</div>
                    </div>
                </div>
