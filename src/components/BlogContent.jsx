                        ...
                        return (
                            <div key={i} className="hotel-cta-block" style={{
                                ...
                                <p style={{ color: '#E0E0E0', fontSize: '15px', lineHeight: '1.7', maxWidth: '640px', margin: '0 auto 24px' }}>
                                    Sandane Homes operates hotel properties — <a href="/amaaltash" style={{ color: '#C5A572', fontWeight: 'bold', textDecoration: 'underline' }}>Amaaltash</a>, <a href="/saffron" style={{ color: '#C5A572', fontWeight: 'bold', textDecoration: 'underline' }}>Saffron Inn</a>, <a href="/pine-tales" style={{ color: '#C5A572', fontWeight: 'bold', textDecoration: 'underline' }}>Pine Tales</a>, <a href="/coco-house" style={{ color: '#C5A572', fontWeight: 'bold', textDecoration: 'underline' }}>CoCo House</a>, and <a href="/glam" style={{ color: '#C5A572', fontWeight: 'bold', textDecoration: 'underline' }}>The Glam</a> — minutes from India Expo Mart, Expo Plaza, Pari Chowk, and Knowledge Park. Corporate rates, GST invoicing, group booking consolidation, and multi-language support.
                                </p>
