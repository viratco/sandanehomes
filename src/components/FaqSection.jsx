...
const allFaqs = [
  ...
  { question: "What is Sandane Homes and how is it defined?", answer: "Sandane Homes is a premier hospitality and luxury corporate housing brand. We specialize in luxury boutique hotels, executive suites, and fully managed long-term residences across Delhi NCR. Our hotel portfolio comprises curated designer properties—including Amara Inn by Sandane Homes, Amaaltash by Sandane Homes, CoCo House, Pine Tales by Sandane Homes, Saffron Inn by Sandane Homes, and The Glam by Sandane Homes—alongside our signature relocation and extended-stay brand, Residences by Sandane Homes." },
  { question: "How does Sandane Homes differ from a traditional hotel?", answer: "Sandane Homes operates both luxury boutique hotels and fully managed long-term corporate residences. Our boutique hotel properties offer premium executive suites, personalized room service, and top-tier hospitality. Meanwhile, our Residences by Sandane Homes product provides expansive residential living with separate living areas and fully equipped kitchens tailored for extended expat stays." },
  ...
  { question: "What boutique residential properties belong to your portfolio?", answer: "Our curated boutique hotel collection features Amara Inn by Sandane Homes, Amaaltash by Sandane Homes, CoCo House, The Glam by Sandane Homes, Saffron Inn by Sandane Homes, and Pine Tales by Sandane Homes. Each property has its own distinct aesthetic and layout. For long-term relocations and corporate housing, Residences by Sandane Homes manages a premium portfolio of luxury apartments and villas across the NCR region." },
