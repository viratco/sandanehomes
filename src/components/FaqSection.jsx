...
const allFaqs = [
  ...
  { question: "In which locations does Sandane Homes operate?", answer: "While our flagship boutique executive residences are based in Greater Noida, our managed corporate apartments and luxury villas under Catarina operate across Noida, Greater Noida, and Gurgaon. We selectively choose properties in premium gated communities (such as Jaypee Greens, DLF, and Godrej Golf Links) to ensure elite safety, accessibility, and lifestyle amenities." },
  { question: "What boutique residential properties belong to your portfolio?", answer: "Our curated collection features Amara, Amaaltash, CoCo House, Glam, Saffron, and Pine Tales. Each property has its own distinct aesthetic and layout. For long-term relocations and corporate housing, Catarina by Sandane Homes manages a premium list of luxury apartments and villas across the NCR region." },
  { question: "Does Sandane Homes help international expats relocate to India?", answer: "Absolutely. Expat relocation is our signature expertise. Through Catarina by Sandane Homes, we offer complete end-to-end housing solutions. From selecting a residence in a secure, expat-friendly gated community to custom-furnishing, installing high-speed fiber internet, setting up utility billing, and providing regular housekeeping, we ensure a turnkey move-in experience. Our aim is to make global executives feel completely at home the moment they arrive." },
  { question: "What is included in a turnkey Catarina residential package?", answer: "Our all-inclusive package covers designer furniture, curated linens (changed twice weekly), daily housekeeping, high-speed fiber Wi-Fi (up to 300 Mbps), smart entertainment screens, water purification systems, 100% power backup, and complete facility maintenance. All utilities and services are bundled into a single, consolidated corporate invoice." },
  { question: "How do you support expat guests in adapting to their new surroundings?", answer: "We provide comprehensive cultural and lifestyle onboarding. Our guest relations team assists expats with neighborhood orientation, language support, identifying reputable medical centers, setting up local deliveries, and sourcing specific dietary ingredients. Having hosted numerous Korean, Japanese, European, and American guests, we are deeply attuned to international lifestyles and preferences." },
  { question: "Can companies establish long-term corporate housing contracts with you?", answer: "Yes. We offer fully customizable corporate leasing contracts. Under Catarina, corporations can secure multi-month or annual leases on luxury 2BHK, 3BHK, and 4BHK apartments or private villas for their teams, with single-point management, custom modifications, and professional housekeeping included." },
  ...
  { question: "Are kitchen facilities provided in the serviced apartments?", answer: "Yes. Many of our corporate suites and all Catarina apartments feature fully-equipped modern kitchenettes or full-sized kitchens with premium appliances, allowing international guests to cook meals according to their preferences." },
];
