...
const allFaqs = [
  ...
  { question: "How does Sandane Homes ease the emotional and physical stress of relocating to India for international expats?", answer: "We understand that moving to a new country is far more than just a logistical shift—it is an emotional transition. Leaving behind familiar comforts to start anew in Delhi NCR can feel overwhelming. Whether you are relocating from Japan, South Korea, the UK, the USA, or Europe, Sandane Homes is built to be your sanctuary. We anticipate the everyday adjustments of settling in—from ensuring 100% pure RO-filtered drinking water and uninterrupted power backup to providing curated international groceries and setting up local transit. Our goal is to offer a soft landing, where you walk into a warm, fully set-up residence and immediately feel secure, cared for, and truly at home." },
